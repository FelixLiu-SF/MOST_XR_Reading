...
Global MOST_RV3_XB_Vars() As String
Global MOST_RV4_XB_Vars() As String

Global MOST_RV1234_LXB_Vars() As String
Global MOST_RV12_LXB_Vars() As String
Global MOST_RV34_LXB_Vars() As String
Global MOST_RV12_LXB_PFKLG(4) As String

Global MOST_RV3_LXB_Vars() As String
Global MOST_RV4_LXB_Vars() As String
...
Public Function MOST_Load_VariableNameArrays()
  ...
  MOST_RV12_LXB_PFKLG(2) = "RV2LXRPFKLG"
  MOST_RV12_LXB_PFKLG(3) = "RV2LXLPFKLG"
...
Public Function SetComboSelection_RV1234(FormName As String, SubFormControlName As String, ViewPrefix As String, VarNameRoot As String, SelectionStr As String, MenuLimitBoolean As Boolean, ColHeaderBoolean As Boolean)
    ...
    For Index = 0 To 3
        ...
        OnFocusStr = Make_ControlUpdate_Func(FormName, SubFormControlName, ControlName, SelectionStr, 3, 1, "0.01 in; 0.5 in; 2 in", 3, MenuLimitBoolean, ColHeaderBoolean)
