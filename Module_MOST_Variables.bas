...
Public MOST_Visits_Array As String(4)
Public MOST_PAKnee_Array As String(2)
Public MOST_LATKnee_Array As String(2)
Public MOST_PARoot_Array As String(19)
Public MOST_LATRoot_Array As String(18)
